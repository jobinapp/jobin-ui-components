...
.add("Default", () =>
    <Modal
        ...
        subtitle={text("subtitle", "Aqui podrás escribir todo lo que necesites mostrar al usuario o añadir contenido custom a través de props.children")}
...
.add("With action button", () =>
    <Modal
        ...
        subtitle={text("subtitle", "Te dará la opción de añadir una llamada a la acción en la parte baja del modal.")}
